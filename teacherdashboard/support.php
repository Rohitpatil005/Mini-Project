        ...
        <div class="flex-1 p-6">
            ...
            <section class="mt-6">
                ...
                <div class="bg-white p-5 rounded-lg shadow-lg">
                    <p>📞 Contact IT Support: +91 9876543210</p>
                    <p>📧 Email: support@university.edu</p>
                    <p>💡 FAQs & Troubleshooting Guide</p>
                </div>
            </section>

            <section class="mt-6">
                <h2 class="text-xl font-semibold mb-3">📩 Submit a Query</h2>
                <div class="bg-white p-5 rounded-lg shadow-lg">
                    <form>
                        <label for="name" class="block text-gray-700 font-semibold">Name:</label>
                        <input type="text" id="name" class="w-full p-2 border rounded mb-4">

                        <label for="email" class="block text-gray-700 font-semibold">Email:</label>
                        <input type="email" id="email" class="w-full p-2 border rounded mb-4">

                        <label for="message" class="block text-gray-700 font-semibold">Message:</label>
                        <textarea id="message" rows="4" class="w-full p-2 border rounded mb-4"></textarea>
